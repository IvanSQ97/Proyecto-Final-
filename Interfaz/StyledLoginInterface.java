...
constraints.fill = GridBagConstraints.HORIZONTAL;
        ...
        JLabel creditCardLabel = new JLabel("Tarjeta de Crédito:");
        ...
        constraints.gridy = 9;
        panel.add(creditCardLabel, constraints);

        constraints.gridy = 10;
        panel.add(creditCardField, constraints);
        ...
        registerButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    statement.setString(5, creditCard);
